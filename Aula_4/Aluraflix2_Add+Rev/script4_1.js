function removerElementos(event) {
  event.target.parentElement.remove();
}

function adicionarElementos() {
  var filmeFavorito = document.getElementById("link").value;
  var elementosListaFilmes = document.getElementById("listaMidiaImagem");
  ...
  imagem.addEventListener("click", removerElementos);
  botaoRemover.innerHTML = "Remover";
  botaoRemover.addEventListener("click", removerElementos);

  item.appendChild(imagem);
  item.appendChild(botaoRemover);
  elementosListaFilmes.appendChild(item);
